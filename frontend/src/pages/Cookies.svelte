<script>
  ...
  const seoData = generatePageSEO(
    "Cookie Policy",
    "FixtureCast cookie policy and usage information.",
    "/cookies",
  );
  ...
  <div class="glass-card p-8 element-enter stagger-2">
    ...
    <div class="prose prose-invert max-w-none space-y-6 text-slate-300">
      ...
      <section>
        ...
        <h3 class="text-lg font-medium text-white mt-4 mb-2">
          Essential Cookies
        </h3>
        <p>
          ...
          <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-700">
              ...
              <tr>
                ...
                <td class="px-4 py-2"
                  >Stores fixtures selected for comparison</td
                >
        ...
        <h3 class="text-lg font-medium text-white mt-6 mb-2">
          Analytics Cookies (Optional)
        </h3>
        <p>
          We do not currently use any analytics cookies. If we add analytics in
          the future, we will update this page and request your consent before
          setting any analytics cookies.
        </p>
      </section>
      ...
      <section>
        ...
        <ul class="list-disc pl-6 mt-2 space-y-1">
          <li>
            <strong>Our Cookie Banner:</strong> Use the cookie banner when you first
            visit to accept or reject optional cookies
          </li>
          <li>
            <strong>Reset Preferences:</strong> Click the button below to reset your
            cookie choices
          </li>
          <li>
      ...
      <section>
        ...
        <ul class="list-disc pl-6 mt-2 space-y-1">
          <li>
            <strong>Content delivery networks:</strong> For loading team logos and
            images
          </li>
        </ul>
        <p class="mt-3">
        ...
        <ul class="list-disc pl-6 mt-2 space-y-1">
          <li>
            <a
              ...
              class="text-cyan-400 hover:underline">Chrome</a
            >
          </li>
          <li>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="text-cyan-400 hover:underline">Firefox</a
            >
          </li>
          <li>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="text-cyan-400 hover:underline">Safari</a
            >
          </li>
          <li>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="text-cyan-400 hover:underline">Edge</a
            >
          </li>
        </ul>
      </section>
